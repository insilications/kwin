...
Version  : 5.23.90
Release  : 302
URL      : file:///aot/build/clearlinux/packages/kwin/kwin-v5.23.90.tar.gz
Source0  : file:///aot/build/clearlinux/packages/kwin/kwin-v5.23.90.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643428791
mkdir -p clr-build
pushd clr-build
